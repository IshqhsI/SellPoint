                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <button class="text-white focus:outline-none">
                            ...
                            <span class="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center">3</span>
                        </button>
                    </div>

                    <div class="flex items-center space-x-2">
                        <div class="bg-white text-blue-800 rounded-full h-8 w-8 flex items-center justify-center font-bold shadow-md">
                            A
                        </div>
