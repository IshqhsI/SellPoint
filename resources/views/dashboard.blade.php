            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <div class="bg-white border border-indigo-600 rounded-xl p-4 shadow hover:shadow-lg transition">
                            <p class="text-sm text-gray-500">Penjualan Hari Ini</p>
                            <p class="text-xl font-bold mt-1 text-indigo-600">{{ 'Rp. ' . number_format($salesToday) }}
                            </p>
                        </div>
                        <div class="bg-white border border-indigo-600 rounded-xl p-4 shadow hover:shadow-lg transition">
